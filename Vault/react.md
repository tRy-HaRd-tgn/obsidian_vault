...
{likes} - можно прописать внутри тега чтобы выводить количество лайков.
# useState
...
Синтаксис объявления состояния - const [count,setCount] = useState(0);
Наращивание количества лайков setCount(count+1);