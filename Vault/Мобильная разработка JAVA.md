...
- Ошибки - JSONExeption 
У каждого из представленных выше методов есть методы для получения внутренней структуры - массива, объекта или значения: getBoolean, getDouble, getJSONObject и т.д. Стоит отменить, что эти классы 